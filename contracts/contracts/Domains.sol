...
contract Domains is ERC721URIStorage, Pausable, Ownable {
    ...
    function updatePrice(uint256 newPrice) onlyOwner public {
        price = newPrice;
    }
    ...
    function changeAddress(string calldata name, address newAddress) whenNotPaused public {
    ...
    function setTwitter(string calldata name, string calldata record) whenNotPaused public {
